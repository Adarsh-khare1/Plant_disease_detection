    ...
    <header className="fixed top-0 inset-x-0 z-50 bg-background/90 backdrop-blur-xl shadow-[0_1px_8px_rgba(0,0,0,0.03)] border-b border-border/40">
      <div className="max-w-5xl mx-auto h-16 px-4 flex items-center justify-between gap-2">
        ...
        >
          ...
          <Link href="/diseases" className="hover:text-primary transition-colors focus-visible:outline-2 focus-visible:outline-primary rounded px-1">
            Disease Library
          </Link>
          ...
          <Link href="/about" className="hover:text-primary transition-colors focus-visible:outline-2 focus-visible:outline-primary rounded px-1">
            About
          </Link>
        </nav>
